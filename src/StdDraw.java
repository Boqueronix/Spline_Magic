 ...
 *  <p>
 *  <b>Window title.</b>
 *  By default, the standard drawing window title is "Standard Graphics.Draw".
 ...
 *  <li> Graphics.Draw objects on the offscreen canvas.
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener, WindowListener {
    ...
    private static final String DEFAULT_WINDOW_TITLE = "Standard Graphics.Draw";
